...
export const updateSclassFields = (id, fields) => async (dispatch) => {
    dispatch(getRequest());

    try {
        const result = await axios.put(`${import.meta.env.VITE_BASE_URL}/Sclass/${id}`, fields, {
...
export const updateSubjectFields = (id, fields) => async (dispatch) => {
    dispatch(getRequest());

    try {
        const result = await axios.put(`${import.meta.env.VITE_BASE_URL}/Subject/${id}`, fields, {
            headers: { 'Content-Type': 'application/json' },
        });
        return result.data;
    } catch (error) {
...
export const deleteSclassItem = (id, address) => async (dispatch) => {
    dispatch(getRequest());
