        ...
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
            <Avatar sx={{ 
                ...
                {String(currentUser?.name || 'S').charAt(0).toUpperCase()}
            </Avatar>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    <IconWrapper>
                        <BadgeIcon sx={{ color: '#e73c7e' }} />
                    </IconWrapper>
                    <Box>
                        <Typography variant="body2" sx={{ color: '#888', fontFamily: 'Poppins' }}>Roll No</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>{currentUser.rollNum}</Typography>
                    </Box>
                </InfoBox>
            </Grid>
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    ...
                    <Box>
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>{sclassName?.sclassName}</Typography>
                    </Box>
                </InfoBox>
            </Grid>
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    ...
                    <Box>
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>{studentSchool?.schoolName}</Typography>
                    </Box>
                </InfoBox>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    <IconWrapper>
                        <CakeIcon sx={{ color: '#f57c00' }} />
                    </IconWrapper>
                    <Box>
                        <Typography variant="body2" sx={{ color: '#888', fontFamily: 'Poppins' }}>Date of Birth</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>January 1, 2000</Typography>
                    </Box>
                </InfoBox>
            </Grid>
            <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    ...
                    <Box>
                        <Typography variant="body2" sx={{ color: '#888', fontFamily: 'Poppins' }}>Email</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>john.doe@example.com</Typography>
                    </Box>
                </InfoBox>
            </Grid>
            <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
                <InfoBox>
                    <IconWrapper>
                        <ContactPhoneIcon sx={{ color: '#00796b' }} />
                    </IconWrapper>
                    <Box>
                        <Typography variant="body2" sx={{ color: '#888', fontFamily: 'Poppins' }}>Emergency Contact</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 600, color: '#252525', fontFamily: 'Poppins' }}>(987) 654-3210</Typography>
                    </Box>
                </InfoBox>
            </Grid>
          </Grid>
